...
BiwaScheme.funcStore = {};
BiwaScheme.funcStore.storage = {};
...
BiwaScheme.define_libfunc = function(fname, min, max, func, is_raw){
  ...
  BiwaScheme.funcStore.storage[fname] = {};
  BiwaScheme.funcStore.storage[fname].min = min;
  BiwaScheme.funcStore.storage[fname].max = max;
  BiwaScheme.funcStore.storage[fname].func = func;
